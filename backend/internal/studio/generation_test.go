...
func TestValidateImageModelSize(t *testing.T) {
	tests := []struct {
		...
		{name: "gpt image 2.5 sunburst 2k", model: "gpt-image-2.5-sunburst", size: "2000x1600"},
		{name: "gpt image 2.5 sunburst rejects off-table size", model: "gpt-image-2.5-sunburst", size: "4096x4096", wantErr: true},
